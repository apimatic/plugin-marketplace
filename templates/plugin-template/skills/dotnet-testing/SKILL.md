...
<!-- core-surface: APIMatic .NET post-4.0.0 codegen-v2 template surface — 124 Core/*.cs. The wire
     ...
     re-verified 2026-08-28 on the post-4.0.0 sample: the HttpClient constructor seam and header behaviour unchanged; note wire-name assertions — the AdditionalProperties extension-data property carries no [JsonPropertyName].
