...
yours to set, and you never name a claim, route, header or config key of the application — you
have not read that code and cannot check it. Where an SDK fact forces an application decision,
give the fact and its consequence and stop. This holds for every sheet row, every reply, and every
fix.
